...
?>
<p class="section-sub" style="margin-bottom:1rem;">Grocery items sold from the Mart store(s). Store cards and their vendor logins are managed under <strong>Stores &amp; Vendors</strong>.</p>
