...
admin_page_start('Contacts', 'contacts', '☎️ Service Contacts');
?>
<form action="admin_save.php" method="POST" class="admin-form">
        ...
        <div class="admin-grid">
            ...
            <div class="admin-card">
                ...
                <div class="admin-field-row">
                    ...
                    <div><label>Emoji</label><input type="text" name="contacts[<?= $i ?>][ico]" value="<?= htmlspecialchars($c['ico']) ?>"></div>
                </div>
            ...
            <div class="admin-card admin-add-card">
                ...
                <div class="admin-field-row">
                    ...
                    <div><label>Emoji</label><input type="text" name="new_contact[ico]" placeholder="📞"></div>
                </div>
    ...
    <button type="submit" class="btn btn-primary btn-block admin-save-btn">💾 Save Contact Changes</button>
</form>
<?php
admin_page_end();
