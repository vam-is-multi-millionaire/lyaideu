        ...
        <div class="container">
            <div class="faq-help-card">
                ...
                <div class="faq-help-actions">
                    <a class="btn btn-primary" href="contact.php"><i class="fa-solid fa-phone"></i> Contact Us</a>
...
<footer class="footer">
    <div class="footer-grid">
        ...
        <div><h4>Quick Links</h4><ul><li><a href="index.php">Home</a></li><li><a href="menu.php">Menu</a></li><li><a href="hotels.php">Hotels</a></li><li><a href="contact.php">Contact</a></li><li><a href="faq.php">FAQ &amp; Privacy</a></li><li><a href="demo.html"><i class="fa-solid fa-film"></i> Product Demo</a></li></ul></div>
