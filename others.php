    ...
    <section id="others" class="section">
        <div class="container">
            <div class="section-head">
                <p class="kicker"><i class="fa-solid fa-gift"></i> Flowers, candles, achar &amp; gifts â€” delivered to your door</p>
                <h1 class="display">LyaiDeu Others <i class="fa-solid fa-gift"></i></h1>
                <p class="section-sub">Surprises, celebrations and everyday extras from our partner stores â€” add them to your cart with your food.</p>
