...
<link rel="stylesheet" href="css/style.css?v=25"></head>
...
function admin_page_start(string $pageTitle, string $activeNav, ?string $heading = null): void {
    ...
    echo '
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css">
<link rel="stylesheet" href="css/style.css?v=25"></head><body class="admin-body">';
...
function admin_page_end(): void {
    ...
    echo '<script src="js/scroll-memory.js?v=4"></script>';
    echo '</body></html>';
}
