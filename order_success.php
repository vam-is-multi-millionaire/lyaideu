...
<link rel="stylesheet" href="css/style.css?v=62"></head><body class="checkout-body"><header class="topbar">
    <nav class="nav">
...
</div></main><script>localStorage.removeItem('fe_cart');</script><script src="js/script.js?v=41"></script><script src="js/scroll-memory.js?v=6"></script><script src="js/notify.js?v=8"></script></body></html>
