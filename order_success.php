...
</div></main><script>localStorage.removeItem('fe_cart');</script><script src="js/script.js?v=38"></script><script src="js/scroll-memory.js?v=6"></script><script src="js/notify.js?v=8"></script></body></html>
