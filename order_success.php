...
</div></main><script>localStorage.removeItem('fe_cart');</script><script src="js/script.js?v=18"></script><script src="js/scroll-memory.js?v=3"></script><script src="js/notify.js?v=4"></script></body></html>
