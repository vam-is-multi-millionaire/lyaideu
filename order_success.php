...
<link rel="stylesheet" href="css/style.css?v=43"></head><body class="checkout-body"><header class="topbar">
    <nav class="nav">
...
</div></main><script>localStorage.removeItem('fe_cart');</script><script src="js/script.js?v=29"></script><script src="js/scroll-memory.js?v=5"></script><script src="js/notify.js?v=6"></script></body></html>
